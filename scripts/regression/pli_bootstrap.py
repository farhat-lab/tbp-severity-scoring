...
JSON_FILE = os.path.join(DATA_PATH, "log_min_max_pli_values.json")  # JSON file containing values to inverse the log transform and min-max scaling
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = self.dataframe.iloc[idx]['normalized_log_overallpercentofabnormalvolume']
...
sampled_labels = [main_df[main_df['patient_id'] == id]['overallpercentofabnormalvolume'].values[0] for id in sampled_image_ids]
